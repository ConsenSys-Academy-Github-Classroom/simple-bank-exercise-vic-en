...
contract SimpleBank {
    ...
    function deposit() public payable returns (uint) {
      ...
      require(enrolled[msg.sender], 'NOT_ENROLED');
    ...
    function withdraw(uint withdrawAmount) public returns (uint) {
      ...
      require(balances[msg.sender] >= withdrawAmount, 'INSUFFICIENT_BALANCE');
      ...
      emit LogWithdrawal(msg.sender, withdrawAmount, this.getBalance());
